...
export default class ChainComponent extends Component<void> {
     ...
     * @param gameObj game object or function that returns a game object
     */
    addComponentAndWait(component: Component<any> | Func<void, Component<any>>, gameObj: Container | Func<void, Container> = null): ChainComponent {
     ...
     * @param gameObj game object or function that returns a game object
     */
    addComponentsAndWait(components: Component<any>[], gameObj: Container | Func<void, Container> = null): ChainComponent {
